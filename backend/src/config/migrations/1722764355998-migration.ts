...
export class Migration1722764355998 implements MigrationInterface {
    name = 'Migration1722764355998'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "trip" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" TIMESTAMP NOT NULL, "price" integer NOT NULL, "status" character varying NOT NULL DEFAULT 'new', "numberOfPassengers" integer NOT NULL, "startLocation" character varying NOT NULL, "stopLocations" character varying NOT NULL, "endLocation" character varying NOT NULL, "vehicleType" character varying, "vehicleModel" character varying NOT NULL, "licensePlateNumber" character varying NOT NULL, "estimatedDuration" integer NOT NULL, "startTime" character varying NOT NULL, "endTime" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "driverId" uuid, CONSTRAINT "PK_714c23d558208081dbccb9d9268" PRIMARY KEY ("id"))`);
